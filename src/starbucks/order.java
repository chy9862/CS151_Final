            ...
            for(Product p : products){
                ...
                if(p instanceof Drink){
                    ...
                    if(Name.equals(p.getName())&& Size.equals("s")){
                        ...
                        if(quantityAndCustomized.size()>=2){

                            //calculate customize
                            if(quantityAndCustomized.get(1) != null && !quantityAndCustomized.get(1).equals("") ){
                ...
                else if(p instanceof Food && Order.equals(p.getName())){
                    ArrayList<String> quantityAndCustomized  = order.getValue();
                    int quantityInt = parseInt(quantityAndCustomized.get(0));
                    totalCost += p.getPrice() * quantityInt;
                ...
                else if(p instanceof Merchandise && Order.equals(p.getName())){
                    ArrayList<String> quantityAndCustomized  = order.getValue();
                    int quantityInt = parseInt(quantityAndCustomized.get(0));
                    totalCost += p.getPrice() * quantityInt;
